...
function changeColorAndBorder(item) {
...
function returnCurrentTargetItem(item) {
    return {
        texto: item.innerText,
        elemento: item
    };
}
const link1 = document.querySelector('.orig');
if (link1)
    console.log(returnCurrentTargetItem(link1));
